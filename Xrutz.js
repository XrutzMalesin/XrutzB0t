...
Silahkan ketik #menu Untuk memulai Bot!`,
			...
			only: {
				...
				Badmin: '_*Xrutzbot Bukan Admin_*'
			}
		}
//
...
const fakefoto = { key: {fromMe: false, participant: `${numbernye}@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast"}: {})}, message: {imageMessage: {caption: `${week}, ${calender} 𝐘𝐨𝐮𝐭𝐮𝐛𝐞 : 𝐗𝐫𝐮𝐭𝐳 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥`, jpegThumbnail: thumb}}}
const fakevideo = { key: {fromMe: false, participant: `${numbernye}@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast"}: {})}, message: {videoMessage: {caption: `${week}, ${calender} 𝐘𝐨𝐮𝐭𝐮𝐛𝐞 : 𝐗𝐫𝐮𝐭𝐳 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥`, jpegThumbnail: thumb}}}
...
const fakekontak = {key: {fromMe: false, participant: `${numbernye}@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast" } : {}) }, message: {contactMessage: {displayName: `${week}, ${calender} 𝐘𝐨𝐮𝐭𝐮𝐛𝐞 : 𝐗𝐫𝐮𝐭𝐳 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥`, vcard: 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'N:Bot;Xrell;Ganz;;\n' + 'FN:Xrutz-Bot\n' + 'item1.TEL;waid=6283871990243:+62 838-719-90243\n' + 'item1.X-ABLabel:Telepon\n' + 'END:VCARD'}}}
const faketoko = {key: {fromMe: false, participant: `${numbernye}@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast" } : {}) }, message: {productMessage: {product: {currencyCode: "BRL", title: `𝐗𝐫𝐮𝐭𝐳 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥`, priceAmount1000: 2000, productImageCount: 2007, productImage: {jpegThumbnail: thumb}}, businessOwnerJid: `${numbernye}@s.whatsapp.net`}}}
const fakedoc = {key: {fromMe: false, participant: `${numbernye}@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast" } : {}) }, message: {documentMessage: {mimetype: 'application/octet-stream', title: `${week}, ${calender} 𝐘𝐨𝐮𝐭𝐮𝐛𝐞 : 𝐗𝐫𝐮𝐭𝐳 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥`, pageCount: 0, fileName: `Hallo ${pushname}`, jpegThumbnail: thumb}}}
...
const fakeinvite = {key: {fromMe: false, participant: `${numbernye}@s.whatsapp.net`, remoteJid: `${numbernye}@s.whatsapp.net`}, message: {groupInviteMessage: {groupJid: from, inviteCode: `${week}, ${calender} 𝐘𝐨𝐮𝐭𝐮𝐛𝐞 : 𝐗𝐫𝐮𝐭𝐳 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥`, groupName: groupName, caption: `Hallo ${pushname}`, jpegThumbnail: thumb}}}
const ftex = {
	 key: { 
          fromMe: false,
...
Selamat, anda telah terdaftar dalam Database XrutzBot, 
...
*[ NOTICE ] :* Jika ada spam XrutzBot langsung mendeteksi 
...
{buttonId: `${prefix}storegame`,buttonText:{displayText: 'STORE GAME 💎'},type:1}
        ...
        if (!isUser) return reply(mess.noregis)
               list = []
               listmenu = [`groupmenu`,`stickermenu`,`islammenu`,`sertimenu`,`ceritamenu`,`makermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`toolsmenu`]
               listmenuu = [`Menu Group`,`Sticker Menu`,`Islam Menu`,`Serti Menu`,`Cerita Menu`,`Maker Menu`,`Owner Menu`,`Game Menu`,`Fun Menu`,`Downloader`,`Info Menu`,`Other Menu`,`Tools Menu`]
               nombor = 1
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'List Menu ' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: `Subscribe Xrutz Official`,
                        rowId: `${prefix}${x}`
                      }
                    ]
                   }
...
//------------------< Premium >-------------------
       ...
       if (isBanned) return reply(mess.ban)
       if (!isUser) return reply(mess.noregis)
              gopeynya = 'https://telegra.ph/file/dbf39a185647132129f3f.jpg'
              teksnya = `*[ PRICE LIST ]*
...
*き⃟🦈 ${prefix}chat* _nomor|teks_`
              Xrutz.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftext, caption: teksnya })
              break
...
Xrutz.sendMessage(_.jid, 
      ...
      case 'start':
             if (!isOwner) return 
             replyf(`Xrutzbot segera diAktifkan!`)
             await sleep(3000)
             process.exit()
             break             
      case 'restart':
